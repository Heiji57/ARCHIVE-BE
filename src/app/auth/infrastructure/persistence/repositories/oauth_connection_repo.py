...
from app.auth.domain.exceptions.exceptions import OAuthAccountAlreadyLinkedException
...
_UNIQUE_VIOLATIONS = {
    "uq_oauth_connections_provider_user": OAuthAccountAlreadyLinkedException,
}
...
class OAuthConnectionRepository(IOAuthConnectionRepository):
    ...
    def _to_model(self, entity: OAuthConnection) -> OAuthConnectionModel:
        return OAuthConnectionModel(
            ...
            provider_verified_emails=entity.provider_verified_emails,
    ...
    def _to_entity(self, model: OAuthConnectionModel) -> OAuthConnection:
        return OAuthConnection(
            ...
            provider_verified_emails=model.provider_verified_emails,
